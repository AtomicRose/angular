app.factory('helper', [function () {
    ...
    return {
        ...
        moneyFormat: {
            pennyToDollar: function (account) {
            ...
            dollarToPenny: function (account) {
                var num = parseFloat(account);
                return num * 100;
            }
        },
        ...
        getDistrictListsByCity: function(_city){
            var _district = [];
            for(var i=0; i<citys.length; i++){
                if (citys[i].name == _city) {
                    _district = citys[i].cities;
                    return _district;
                }
            }
            return _district;
